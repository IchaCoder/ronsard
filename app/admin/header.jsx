      ...
      <div className="text-white text-sm flex relative gap-1.5 items-center">
        ...
        <div className="absolute -bottom-8 right-0">
          <button
            ...
            className="text-red-600 flex p-2 bg-gray-100 hover:bg-red-600 hover:text-white transition duration-500 border border-red-600 rounded-lg justify-center items-center gap-2 w-full group text-sm"
          >
            <svg
